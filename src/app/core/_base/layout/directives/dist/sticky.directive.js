...
var StickyDirective = /** @class */ (function () {
    ...
    StickyDirective.prototype.determineStatus = function (originalVals, pageYOffset, marginTop, marginBottom, enabled) {
        ...
        var reachedLowerEdge = this.boundaryElement &&
    ...
    __decorate([
        core_1.Input()
    ], StickyDirective.prototype, "scrollContainer");
    __decorate([
        core_1.Input('spacerElement')
    ], StickyDirective.prototype, "spacerElement");
    __decorate([
        core_1.Input('boundaryElement')
    ], StickyDirective.prototype, "boundaryElement");
    __decorate([
        core_1.HostBinding('class.is-sticky')
    ], StickyDirective.prototype, "sticky");
    __decorate([
        core_1.HostBinding('class.boundary-reached')
    ], StickyDirective.prototype, "boundaryReached");
    __decorate([
        core_1.Input()
    ], StickyDirective.prototype, "marginTop");
    __decorate([
        core_1.Input()
    ], StickyDirective.prototype, "marginBottom");
    __decorate([
        core_1.Input()
    ], StickyDirective.prototype, "enable");
    __decorate([
        core_1.HostListener('window:resize', [])
    ], StickyDirective.prototype, "onWindowResize");
