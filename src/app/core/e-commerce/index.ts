...
export { PropertyModel } from './_models/property.model'
...
export { PropertiesDataSource } from './_data-sources/properties.datasource';
...
export { PropertyEffects } from './_effects/property.effects';
...
export { propertiesReducer } from './_reducers/property.reducers';
...
export { PropertiesService } from './_services/';
